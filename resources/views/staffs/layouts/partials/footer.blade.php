                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img
                                    src="{{ asset('staff/assets/img/logos/footer-logo2.png')}}"
                                    alt="Images">
                            </a>
                        </div>
                        <p>
                        ...
                        <ul class="footer-list-contact">
                            ...
                            <li>
                                ...
                                <a
                                    href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#ff979a939390bf9e8b909396d19c9092"><span
                                        class="__cf_email__"
                                        data-cfemail="7f171a1313103f1e0b101316511c1012">[email&#160;protected]</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="email"
                                                class="form-control border-radius-50"
