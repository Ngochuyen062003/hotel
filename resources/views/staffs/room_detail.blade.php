                    ...
                    <div class="room-details-article">
                        <div
                            ...
                            <div class="room-details-item">
                                <img
                                    src="{{ asset('staff/assets/img/room/room-details-img1.jpg') }}"
                                    alt="Images">
                            </div>
                            <div class="room-details-item">
                                <img
                                    src="{{ asset('staff/assets/img/room/room-details-img2.jpg') }}"
                                    alt="Images">
                            </div>
                            <div class="room-details-item">
                                <img
                                    src="{{ asset('staff/assets/img/room/room-details-img3.jpg') }}"
                                    alt="Images">
                            </div>
                        </div>
                        <div class="room-details-title">
                            <h2>Double Bed Suits With Royal Express and
                                Super Duplex Feelings</h2>
                            <ul>
                                <li>
