                ...
                <div class="col-lg-8">
                    <div class="service-article">
                        <div class="service-article-img">
                            <img src="{{ asset('staff/assets/img/service-details-img.jpg') }}"
                                alt="Images">
                        </div>
                        <div class="service-article-title">
                            <h2>Hotel Room Reservation into the Desire
                                Places</h2>
                        </div>
                        ...
                        <div class="service-facility-content">
                            ...
                            <ul>
                                <li><i class="bx bxs-check-circle"></i>Wifi
                                    Coverage</li>
                                <li><i class="bx bxs-check-circle"></i>Pool
                                    & Spa</li>
                                <li><i class="bx bxs-check-circle"></i>Luxury
                                    Bars</li>
                                <li><i class="bx bxs-check-circle"></i>Cleaning
                                    Everyday</li>
                                <li><i class="bx bxs-check-circle"></i>Sea
                                    View Balcony</li>
                            </ul>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="services-item">
                                        ...
                                        <h3><a href="service-details.html">Resort
                                                Reservation Into a Suitable
                                                Place</a></h3>
                                        <p>One can easily reserve a resort
                                            room in a suitable place as you
                                            want. This will be able to make
                                            good feelings.</p>
                                        <a href="service-details.html"
                                            class="get-btn">Get Service</a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="services-item">
                                        <i class="flaticon-calendar"></i>
                                        <h3><a href="service-details.html">Book
                                                Now to Secure Availability
                                                Time Now</a></h3>
                                        <p>You can easily reserve a hotel
                                            room in a suitable place as you
                                            want. This will be able to make
                                            good feelings.</p>
                                        <a href="service-details.html"
