...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-img-2">
                        <img src="{{ asset('staff/assets/img/about/about-img2.png')}}"
                            alt="Images">
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="room-slider owl-carousel owl-theme pt-45">
                <div class="room-item">
                    <a href="room-details.html">
                        <img src="{{ asset('staff/assets/img/room/room-img7.jpg')}}"
                            alt="Images">
                    </a>
                    <div class="content">
                ...
                <div class="room-item">
                    <a href="room-details.html">
                        <img src="{{ asset('staff/assets/img/room/room-img8.jpg')}}"
                            alt="Images">
                    </a>
                    <div class="content">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="ability-img">
                        <img src="{{ asset('staff/assets/img/ability-img.jpg')}}" alt="Images">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="testimonials-area-two pb-70">
        <div class="container">
            ...
            <div
                class="testimonials-slider-two owl-carousel owl-theme pt-45">
                <div class="testimonials-style">
                    <div class="row align-items-center">
                        <div class="col-lg-7">
                            <div class="testimonials-img">
                                <img
                                    src="{{ asset('staff/assets/img/testimonials/testimonials-style1.jpg')}}"
                                    alt="Images">
                                <div class="content">
                                    <h3>Mary Marden</h3>
                ...
                <div class="testimonials-style">
                    <div class="row align-items-center">
                        <div class="col-lg-7">
                            <div class="testimonials-img">
                                <img
                                    src="{{ asset('staff/assets/img/testimonials/testimonials-style2.jpg')}}"
                                    alt="Images">
                                <div class="content">
    ...
    <div class="faq-area pt-100 pb-70 section-bg-2">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="faq-img-2">
                        <img src="{{ asset('staff/assets/img/faq/faq-img2.jpg')}}" alt="Images">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-xxl-5">
                    <div class="book-content">
                        ...
                        <a href="book.html"
                            class="default-btn btn-bg-two border-radius-50">Quick
                            Booking</a>
                    </div>
                </div>
            </div>
