...
@section('title')
    Gato Cat Hotel - Gallery
@endsection

@section('link-active-gallery')
    active
@endsection

@section('banner')
    <section class="breadcrumb_area" style="background: url('{{asset("client/assets/image/about_banner.jpg")}}') no-repeat scroll center 0/cover;">
            ...
            <div class="row imageGallery1" id="gallery">
                <div class="col-md-4 gallery_item">
                    <div class="gallery_img">
                        <img src="{{asset('client/assets/image/gallery/01.jpg')}}" alt="">
                        <div class="hover">
                ...
                <div class="col-md-4 gallery_item">
                    <div class="gallery_img">
                        <img src="{{asset('client/assets/image/gallery/02.jpg')}}" alt="">
                        <div class="hover">
                ...
                <div class="col-md-4 gallery_item">
                    <div class="gallery_img">
                        <img src="{{asset('client/assets/image/gallery/03.jpg')}}" alt="">
                        <div class="hover">
                ...
                <div class="col-md-4 gallery_item">
                    <div class="gallery_img">
                        <img src="{{asset('client/assets/image/gallery/04.jpg')}}" alt="">
                        <div class="hover">
                ...
                <div class="col-md-4 gallery_item">
                    <div class="gallery_img">
                        <img src="{{asset('client/assets/image/gallery/06.jpg')}}" alt="">
                        <div class="hover">
                ...
                <div class="col-md-4 gallery_item">
                    <div class="gallery_img">
                        <img src="{{asset('client/assets/image/gallery/05.jpg')}}" alt="">
                        <div class="hover">
                ...
                <div class="col-md-4 gallery_item">
                    <div class="gallery_img">
                        <img src="{{asset('client/assets/image/gallery/01-1.jpg')}}" alt="">
                        <div class="hover">
                ...
                <div class="col-md-4 gallery_item">
                    <div class="gallery_img">
                        <img src="{{asset('client/assets/image/gallery/02-1.jpg')}}" alt="">
                        <div class="hover">
                ...
                <div class="col-md-4 gallery_item">
                    <div class="gallery_img">
                        <img src="{{asset('client/assets/image/gallery/03-1.jpg')}}" alt="">
                        <div class="hover">
