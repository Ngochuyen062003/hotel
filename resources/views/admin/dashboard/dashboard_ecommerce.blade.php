                ...
                <div class="card">
                    <div class="d-flex align-items-end row">
                        ...
                        <div class="col-4 pt-3 ps-0">
                            <img src="{{asset('admin/assets/img/illustrations/prize-light.png')}}" width="90" height="140"
                    ...
                    <div class="col-lg-6 col-md-3 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="{{asset('admin/assets/img/icons/unicons/briefcase.png')}}" alt="Credit Card"
                                            class="rounded">
                                    </div>
                                    <div class="dropdown">
                    ...
                    <div class="col-12 col-sm-6 col-md-3 col-lg-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="{{asset('admin/assets/img/icons/unicons/cc-warning.png')}}" alt="Credit Card"
                                            class="rounded">
                                    </div>
                                    <div class="dropdown">
                        ...
                        <table class="table text-nowrap">
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{asset('admin/assets/img/products/oneplus-lg.png')}}" alt="Oneplus"
                                    ...
                                    <td>
                                        <div class="text-muted lh-1"><span class="text-primary fw-medium">$120</span>/499
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{asset('admin/assets/img/products/magic-mouse.png')}}" alt="Apple"
                                                height="32" width="32" class="me-2">
                                            <div class="d-flex flex-column">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{asset('admin/assets/img/products/imac-pro.png')}}" alt="Apple"
                                                height="32" width="32" class="me-2">
                                            <div class="d-flex flex-column">
                                    ...
                                    <td>
                                        <div class="text-muted lh-1"><span class="text-primary fw-medium">$0</span>/899
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{asset('admin/assets/img/products/note10.png')}}" alt="Samsung" height="32"
                                                width="32" class="me-2">
                                            <div class="d-flex flex-column">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{asset('admin/assets/img/products/iphone.png')}}" alt="Apple" height="32"
                                                width="32" class="me-2">
                                            <div class="d-flex flex-column">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{asset('admin/assets/img/products/mi-tv.png')}}" alt="Xiaomi" height="32"
                                                width="32" class="me-2">
                                            <div class="d-flex flex-column">
                                    ...
                                    <td>
                                        <div class="text-muted lh-1"><span class="text-primary fw-medium">$349</span>/2499
                                        </div>
                                        <small class="text-muted">Partially Paid</small>
                                    </td>
                                    <td><span class="badge bg-label-primary">Confirmed</span></td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{asset('admin/assets/img/products/logitech-mx.png')}}" alt="Logitech"
                                                height="32" width="32" class="me-2">
                                            <div class="d-flex flex-column">
