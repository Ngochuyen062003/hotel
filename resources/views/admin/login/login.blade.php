    ...
    <body>
        ...
        <div class="authentication-wrapper authentication-cover">
            ...
            <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
                ...
                <img src="{{asset('admin/assets/img/illustrations/boy-with-rocket-light.png')}}" class="img-fluid" alt="Login image" width="700">
                </div>
            </div>
            <!-- /Left Text -->
            ...
            <div
                ...
                <div class="app-brand mb-5">
                    <a href="index.html" class="app-brand-link row">
                        <span class="app-brand-logo col-3">
                            ...
                            <img src="{{ asset('admin/assets/img/logos/logo4.png') }}" width="40px" alt="">
                ...
                <!-- /Logo -->
                <h4 class="mb-2">Welcome back, Admin ❤️</h4>
