...
$(function () {
    ...
    n.length &&
        ((t = n.DataTable({
            ajax: assetsPath + 'admin/list-rooms',
            columns: [
                { data: 'id' },
                { data: 'name' },
                { data: 'main_image' },
                ...
                },
                {
                    ...
                    render: function (t, e, s, a) {
                        var n = s.name,
                            ...
                            i = s.image
                        return (
                            '<div class="d-flex justify-content-start align-items-center name"><div class="avatar-wrapper"><div class="avatar avatar me-2 rounded-2 bg-label-secondary">' +
                            (i
                                ? '<img src="' +
                                  assetsPath +
            ...
            buttons: [
                ...
                {
                    text: '<i class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add Room</span>',
